...
plt.plot(x[:-1],y, "-.", label="highest adversary")
plt.plot(x[:-1],KA, "ro", label="Knight-Archer")
plt.plot(x[:-1],KW, "ys", label="Knight-Wizard")
plt.plot(x[:-1],AW, "bd", label="Archer-Wizard")
plt.xlabel('Iteration:Best pair')
plt.xticks(rotation='vertical')
ax.legend = legend((KA, KW, AW), ("KA", "KW", "AW"))
